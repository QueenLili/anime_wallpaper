...
url = 'https://anime-pictures.net/pictures/download_image/558618-1920x1080-netsuzou+trap-mizushina+hotaru-okazaki+yuma-tachi+%28gutsutoma%29-long+hair-blush.png'
url = 'https://qd.myapp.com/myapp/qqteam/tim/down/tim_pc.exe'
down = Downloader(url, 3, 'tim_pc.exe')
down.run()