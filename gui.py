...
# resize函数使用过程：
# ==================================================================
w_box = 16  # 期望图像显示的大小（窗口大小）
h_box = 9

pil_image = Image.open('Gallery\\550015-1920x1080-riddle+joker-yuzusoft-nijouin+hazuki-kobuichi-long+hair-single.png')  # 以一个PIL图像对象打开  【调整待转图片格式】
